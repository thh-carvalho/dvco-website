...
export default function HomePage(){
    ...
    return (
            <main id='home-section' className="bg-[url('/dvco-website/bg-home.png')] p-5 h-[100vh] w-full bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center gap-[32px] row-start-2 items-center sm:items-start">
